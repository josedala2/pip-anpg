...
export const oilBlocks: OilBlock[] = [
  ...
  // ── New blocks from ANPG 2025 Production Distribution ──
  {
    ...
    complianceScore: 78,
    concession: [
      { name: "Sonangol P&P", share: 100.0, isOperator: true },
    ],
    mapPosition: { x: 20, y: 58 },
    productionHistory: Array(12).fill(null).map((_, i) => ({ month: ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][i], value: 9000 + Math.round(Math.random() * 700) })),
    capexHistory: [
      { year: "2021", planned: 80, actual: 70 }, { year: "2022", planned: 90, actual: 78 },
      { year: "2023", planned: 95, actual: 85 }, { year: "2024", planned: 100, actual: 90 },
    ],
    projections: { conservative: [9000,8500,8000,7500,7000,6500,6000,5500,5000,4500], base: [9345,9200,9000,8800,8600,8400,8200,8000,7800,7600], expansion: [9345,9800,10200,10500,10800,11000,11200,11000,10800,10500] },
    areaKm2: 2800,
    waterDepthRange: "15-100m",
  },
  {
    id: "block-3-05a",
    name: "Block 3/05A",
    operator: "Sonangol P&P",
    partners: ["Sonangol E&P", "China Sonangol"],
    basin: "Lower Congo",
    phase: "Production",
    waterDepth: "Shallow Water",
    contractDate: "2005-06-01",
    dailyProduction: 51450,
    estimatedReserves: 280,
    accumulatedInvestment: 1800,
    plannedInvestment: 1200,
    executionRate: 75,
    riskScore: 4,
    complianceScore: 80,
    concession: [
      { name: "Sonangol P&P", share: 60.0, isOperator: true },
      { name: "China Sonangol", share: 40.0 },
    ],
    mapPosition: { x: 19, y: 60 },
    productionHistory: Array(12).fill(null).map((_, i) => ({ month: ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][i], value: 49000 + Math.round(Math.random() * 5000) })),
    capexHistory: [
      { year: "2021", planned: 300, actual: 270 }, { year: "2022", planned: 350, actual: 310 },
      { year: "2023", planned: 380, actual: 340 }, { year: "2024", planned: 400, actual: 360 },
    ],
    projections: { conservative: [50000,48000,46000,44000,42000,40000,38000,36000,34000,32000], base: [51450,51000,50500,50000,49500,49000,48500,48000,47500,47000], expansion: [51450,53000,55000,57000,58000,59000,60000,60000,59000,58000] },
    areaKm2: 3200,
    waterDepthRange: "15-120m",
  },
  {
    id: "block-17-06",
    name: "Block 17/06",
