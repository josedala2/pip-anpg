...
import {
  ...
  ShieldCheck, Landmark, Scale, Calendar, Droplets, Activity,
} from "lucide-react";
...
export const ConcessionStatusTab = ({ block }: ConcessionStatusTabProps) => {
  ...
  const alerts = useMemo<Alert[]>(() => {
    ...
    return list;
  }, [monthsRemaining, block.executionRate, block.complianceScore, prodDecline]);
  ...
  return (
    <div className="space-y-4 2xl:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-3 2xl:gap-5">
        {/* Semaphore Card */}
